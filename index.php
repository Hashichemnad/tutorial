...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="#">MicroDegree</a>
...
<div class="container-fluid bg-3 text-center">    
  <h2 class="margin"> Our Features</h2><br>
  <div class="row">
    <div class="col-sm-4">
      <p>Lorem ipsum dolor sit amet.</p><br>
      <i style="font-size:100px;" class="fa fa-bar-chart zoom mr-3"></i>
    </div>
    <div class="col-sm-4"> 
      <p>Lorem ipsum dolor sit amet.</p><br>
      	<i style="font-size:100px;" class="fa fa-puzzle-piece zoom mr-3"></i>
      </div>
    <div class="col-sm-4"> 
      <p>Lorem ipsum dolor sit amet.</p><br>
      <i style="font-size:100px;" class="	fa fa-star zoom mr-3"></i>
    </div>
  </div>
</div>
